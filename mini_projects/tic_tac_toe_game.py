...
class Board:
    ...
    def submit_move(self, player, move):
        row = move.get_row()
        col = move.get_column()
        value = self.game_board[row][col]   # Get current value at that cel
    ...
    def start(self):
        ...
        while True:
            ...
            while True:
                ...
                play_again = input("Would you like to play again. Enter X" \
                "for YES or 0 for NO: ").upper()
                ...
                if play_again == "0":
                    ...
                    print("Your input was not valid but I will assume that" \
